...
public:
	...
	static const Radians pi_half;
	static const Radians pi_double;
	static const Radians pi_quarter;
public:
    explicit Radians(Real angle=0.0f)	:_value(angle)        {}
    Radians(const Radians& other)		:_value(other._value) {}
    Radians(const Degree& degree);

	inline const Real& toReal() const						{return _value;}
	...
	inline GString toString() const							{ return GString::number(_value); }
