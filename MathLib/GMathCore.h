...
inline bool areEqual(const Real& x, const Real& y)
{
...
inline bool isNull(const Real& x)
{
...
//true if |x|<approssimation
inline bool isZero(const GMath::Real& x)		{ return GMath::isNull(x); }
