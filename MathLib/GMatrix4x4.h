...
public:
	...
	inline const Real& x() const								{ return _m[12]; }
	inline const Real& y() const								{ return _m[13]; }
	inline const Real& z() const								{ return _m[14]; }
	inline Real& x()											{ return _m[12]; }
	inline Real& y()											{ return _m[13]; }
	inline Real& z()											{ return _m[14]; }
	...
	inline void setTranslation(Real x, Real y, Real z)					{ _m[12] = x; _m[13] = y; _m[14] = z; }
	inline void setTranlsationX(const Real& x)							{ _m[12] = x; }
	inline void setTranlsationY(const Real& y)							{ _m[13] = y; }
	inline void setTranlsationZ(const Real& z)							{ _m[14] = z; }
