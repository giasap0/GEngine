...
struct GColor
{
	...
	inline void setValues(float r, float g, float b, float a=1.0f)		{red =r; green=g; blue=b; alpha=a;}
	inline bool operator==(const GColor& c2) const						{if(red==c2.red && green==c2.green && blue==c2.blue && alpha==c2.alpha) return true; return false;}
	inline GColor& operator=(const GColor& c2)							{red=c2.red; green=c2.green; blue=c2.blue; alpha=c2.alpha; return *this;}
};
namespace GColors
{
